...
public class ProviderProfile extends AppCompatActivity implements View.OnClickListener,
    ...
    private void setTabs() {
        pager.setAdapter(new PagerAdapter() {
            ...
            public Object instantiateItem(final ViewGroup container, final int position) {
                View view = null;
                LayoutInflater inflater = LayoutInflater.from(ProviderProfile.this);
                switch (position){
                    case 1:
                        RecyclerView recyclerView = new RecyclerView(ProviderProfile.this);
                        ...
                        break;
                    case 2:
                        RecyclerView reviewRecycler = new RecyclerView(ProviderProfile.this);
                        LinearLayoutManager r_linearLayoutManager = new LinearLayoutManager(getApplicationContext());
                        reviewRecycler.setLayoutManager(r_linearLayoutManager);
                        reviewRecycler.setAdapter(new ProfileReviewsAdapter());
                        view = reviewRecycler;
                        break;
                        default:
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new AlertDialog.Builder(ProviderProfile.this)
                .setMessage(message)
...
*/
    ...
    private void createPopupMenu(View v) {
        PopupMenu popupMenu = new PopupMenu(ProviderProfile.this, v);
        popupMenu.setOnMenuItemClickListener(ProviderProfile.this);
    ...
    public boolean onMenuItemClick(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case 1:
                new CreateService().createServiceDialog(ProviderProfile.this);
                return true;
            case 2:
    ...
    public class ProfileserviceAdapter extends RecyclerView.Adapter<ProfileserviceAdapter.MyViewHolder> {
        ...
        public void onBindViewHolder(final MyViewHolder holder, final int position) {
            ...
            holder.edit.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    new UpdateService().updateServiceDialog(data,ProviderProfile.this);
                }
            });
    ...
    public class ProfileReviewsAdapter extends RecyclerView.Adapter<ProfileReviewsAdapter.MyViewHolder> {
        ...
        public ProfileReviewsAdapter() {
        }

        @Override
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.list_rewiews, parent, false);
            MyViewHolder holder = new MyViewHolder(view);
            return holder;
        }
