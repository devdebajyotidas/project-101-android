...
/**
 * Created by XTREMSOFT on 23-Dec-2017.
 */
...
public class OtpView extends LinearLayout {
    ...
    public String getOtp(){
        return ""+mOtpOneField.getText()+mOtpTwoField.getText()+mOtpThreeField.getText()
                +mOtpFourField.getText()+mOtpFiveField.getText()+mOtpSixField.getText();
    }
    ...
    private void init(AttributeSet attrs) {
        ...
        mInflater.inflate(R.layout.optview_layout, this);
