...
import views.doublestickyheader.DoubleHeaderAdapter;
...
public class DoubleHeaderTestAdapter extends RecyclerView.Adapter<DoubleHeaderTestAdapter.ViewHolder> implements
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        final View view = inflater.inflate(R.layout.sticky_item, viewGroup, false);
    ...
    public HeaderHolder onCreateHeaderHolder(ViewGroup parent) {
     //   final View view = inflater.inflate(R.layout.sticky_superheader, parent, false);
        return new HeaderHolder(null);
    }

    @Override
    public SubHeaderHolder onCreateSubHeaderHolder(ViewGroup parent) {
      //  final View view = inflater.inflate(R.layout.sticky_header, parent, false);
        return new SubHeaderHolder(null);
    }
